...
source ~/.config/nvim/keys/keymapslatex.vim
source ~/.config/nvim/keys/keymapshtml.vim
source ~/.config/nvim/keys/keymapsmd.vim
source ~/.config/nvim/keys/keymapscss.vim
